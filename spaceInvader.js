  ...
  Game.prototype = {
    ...
    draw: function() {
      ...
      if (this.lost) {
        ...
        screen.fillText("Leider verloren", gameSize.width / 2, gameSize.height / 2);
        screen.font = "20px Lucida Console";
        screen.fillText("Punkte: " + kills, gameSize.width / 2, gameSize.height / 2 + 30);
        ...
        if (game.invaders.length === 0) {
          ...
          screen.textAlign = "center";
          screen.fillStyle = "white";
          screen.fillText("Du hast gewonnen!", gameSize.width / 2, gameSize.height / 2);
          screen.font = "20px Lucida Console";
          screen.fillText("Punkte: " + kills, gameSize.width / 2, gameSize.height / 2 + 30);
          this.active = false;
        } else {
        ...
        screen.fillText("Punkte: " + kills, gameSize.width, gameSize.height - 12);
        }}
